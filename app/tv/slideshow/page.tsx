...
export default function Slideshow() {
  ...
  // Preload queued images and only show a photo once fully decoded — it
  // appears in one frame instead of painting progressively.
  usePreloadPhotos(photos);
  const current = useLoadedPhoto(activePhoto(photos, now));
